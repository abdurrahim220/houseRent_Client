...
const Search = () => {
  ...
  return (
    <div className="px-[30px] py-6 max-w-[1170px] mx-auto flex flex-col lg:flex-row justify-between gap-2 lg:gap-x-3 relative lg:-top-4 lg:shadow-1 bg-white lg:bg-transparent lg:backdrop-blur">
      <City />
      <Bathrooms />
      <BedRooms />
      <Price />
      <RoomSize />
      <Availability />
      <button className="bg-violet-700 hover:bg-violet-900 rounded-lg h-16 transition w-full lg:max-w-[162px] flex justify-center items-center text-white">
